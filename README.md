...
This function deletes the whole bst tree. Think about what was dynamically allocated in the tree, and be sure to deallocate it. **Make sure to deallocate the bst itself as well.** You can use valgrind to confirm that you have no memory leaks.
